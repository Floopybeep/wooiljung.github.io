...
Before returning to academia, I worked as a Machine Learning Research Engineer at LG Electronics. Over three years, I designed end-to-end training and inference pipelines for edge-deployed speech models, achieving a 98% recognition rate on flagship appliances while optimizing for strict hardware constraints. My technical expertise includes a wide range of skills from Python-C feature extraction APIs to modern deep learning architectures in pytorch.
